...
class HungarianMatcher_semi(nn.Module):
    ...
    def forward(self, outputs, targets, indicators=None):
        ...
        with torch.no_grad():
            ...
            # print("== matcher.py ==")
            # if out_bbox.dim() != 2:
            #     print("out_bbox is NOT 2D")
            # else:
            #     print("out_bbox is fine")
            # if tgt_bbox.dim() != 2:
            #     print("tgt_bbox is NOT 2D")
            # else:
            #     print("tgt_bbox is fine")
            # print("out_bbox shape:", out_bbox.shape)
            # print("out_bbox:", out_bbox)
            # print("tgt_bbox shape:", tgt_bbox.shape)
            # print("tgt_bbox:", tgt_bbox)
            # out_bbox = out_bbox.reshape(1, 2)
            # tgt_bbox = tgt_bbox.reshape(1, 2)
            # try:
