...
def build(image_set, args):
    ...
    if args.dataset_file == "voc_omni":
        ...
        PATHS = {
            "train": (root / "scaled_dataset/train/combinedview",
                      root / "supervised_annotations" / args.annotation_json_label),
...
def build_semi_unlabel(image_set, args):
    ...
    if args.dataset_file == "voc_semi":
        ...
        PATHS = {
            "train": (root / 'unsupervised_annotations' / 'combined',
                      root / "unsupervised_annotations" / args.annotation_json_unlabel),
            "val": (root / "scaled_dataset/val/droneview",
                    root / "supervised_annotations" / 'aerial/aligned_ids/aerial_valid_aligned_ids_w_perspective.json'),
        }
    ...
    img_folder, ann_file = PATHS[image_set]
    print("UNLABELED IMAGE FOLDER:", img_folder)
